...
namespace DatingAPP.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        [FromForm]PhotosForCreationdDto photosForCreationdDto)
        {
            ...
            var file = photosForCreationdDto.File;
            ...
            photosForCreationdDto.PublicId = uploadResult.PublicId;
            photosForCreationdDto.Url = uploadResult.Uri.ToString();

            var photo = _mapper.Map<Photo>(photosForCreationdDto);
